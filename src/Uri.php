...
use Wheakerd\SseClient\Exception\MalformedUriException;
 ...
 */
final class Uri implements UriInterface, JsonSerializable
{
    /**
    ...
    private const array QUERY_SEPARATORS_REPLACEMENT = ['=' => '%3D', '&' => '%26'];
     ...
     * @return array|false
     */
    private static function parse(string $url): false|array
    {
        // If IPv6
        $prefix = '';
    ...
    public static function withQueryValues(UriInterface $uri, array $keyValueArray): UriInterface
    {
        ...
        foreach ($keyValueArray as $key => $value) {
            $result[] = self::generateQueryString((string)$key, $value !== null ? $value : null);
        }
    ...
    private function filterQueryAndFragment(mixed $str): string
    {
        ...
        return preg_replace_callback(
            '/(?:[^' . self::CHAR_UNRESERVED . self::CHAR_SUB_DELIMS . '!$&\'()*+,;=Z0-9_\-.~%name/',
            [$this, 'rawurlencodeMatchZero'],
            $str
        );
    }
